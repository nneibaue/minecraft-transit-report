...
- [x] **Phase 5: Configuration and Async Fetch** - Config-driven base URL and interval; PNG bytes fetched off-thread and logged (parallel to 2-4) (completed 2026-09-08)
...
- [x] 01-01-PLAN.md — Wave 1 (tracer): mod identity + inert-mixin removal, proven by a live dev client launch and a created world (TOOL-01)
...
- [x] 03-02-PLAN.md — Wave 2: the two-line item tooltip — a `Block.appendHoverText` override resolving two new generated translation keys, then a running-client check of the whole phase (craft, break, hover) and the Phase 3 findings written into `docs/DEV.md` (BLOCK-06, GEN-05)
...
| 5. Configuration and Async Fetch | 1/1 | Complete    | 2026-09-08 |
